class CrossplaneAT116 < Formula
  ...
  if OS.mac? && Hardware::CPU.intel?
    url 'https://releases.crossplane.io/stable/v1.16.5/bin/darwin_amd64/crank'
    sha256 '302f5f8c7ae90e70580ae16f1ddcc234c6c0c9becb8393a6bfde8813e98004e9'
  end
  if OS.mac? && Hardware::CPU.arm?
    url 'https://releases.crossplane.io/stable/v1.16.5/bin/darwin_arm64/crank'
    sha256 'b67565e7b366f396f71a45b36329dbbdcab2a4383400649ed461cca264886ddc'
  end
  if OS.linux? && Hardware::CPU.intel?
    url 'https://releases.crossplane.io/stable/v1.16.5/bin/linux_amd64/crank'
    sha256 '151f8b16ee6bd4093d19a438a556f65e13fe4f4ed54ec1a74e90e485c30ae05e'
  end
  if OS.linux? && Hardware::CPU.arm? && !Hardware::CPU.is_64_bit?
    url 'https://releases.crossplane.io/stable/v1.16.5/bin/linux_arm/crank'
    sha256 '73e831aa19733c48ee1a57ecff5779cc0226c0c167d0c412198ad77069706de2'
  end
  if OS.linux? && Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
    url 'https://releases.crossplane.io/stable/v1.16.5/bin/linux_arm64/crank'
